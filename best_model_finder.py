...
class best_model_:
    ...
    models_dict = {
        "Logistic Regression": model_pipeline[0], "Decision Tree": model_pipeline[1], "KNN": model_pipeline[2], "RF": model_pipeline[3]}

    pickle.dump(models_dict[best_model[0]], open('model.pkl', 'wb'))
